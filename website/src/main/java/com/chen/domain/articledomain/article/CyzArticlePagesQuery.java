...
import com.chen.config.mybatisplus.page.PageRequest;
...
@ApiModel(value = "CyzArticlePagesQuery对象", description = "")
public class CyzArticlePagesQuery extends BasePagesQuery implements Serializable {
